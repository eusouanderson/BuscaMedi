<template>
  <div class="max-w-6xl mx-auto p-4">
    ...
    <div class="relative overflow-hidden">
      <div class="flex animate-scroll-carousel gap-5">
        ...
        <div v-for="product in products" :key="product._id"
          ...
          <img :src="product.image_url" alt="Imagem do Produto" class="w-full h-24 object-cover rounded-t-lg mb-4" />
          ...
          <a :href="product.search_link" target="_blank" class="text-blue-500 hover:underline mt-2 inline-block">
            Ver mais
          </a>
        </div>
      </div>
